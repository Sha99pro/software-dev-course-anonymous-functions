...
const sortTasks = todos.sort(function(a , b){
...
console.log("Sorted Incomplete Tasks:", filteredTasks);
...
const modifiedTasks = todos.map(function(todo){
  return {
    ...todo,
    completed : true
  };
});
console.log("All Tasks completed:" , modifiedTasks);
